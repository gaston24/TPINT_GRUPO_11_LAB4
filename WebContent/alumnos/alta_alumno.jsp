...
<div class="row">
<div class="col"></div>
<div class="col"><h3>Cargar alumno nuevo</h3></div>
<div class="col"></div>
</div>
...
<!-- <form> -->
  ...
  <div class="col-md-4 mb-3">
    ...
    <div class="col-md-4 mb-3">
      <label for="validationDefault02">Fecha Nacimiento</label>
      <input type="text" class="form-control" id="validationDefault02" >
    </div>
  </div>
  <div class="form-row">
  <div class="col-md-4 mb-3">
    ...
    <div class="col-md-4 mb-3">
      <label for="validationDefault02">Localidad</label>
      <input type="text" class="form-control" id="validationDefault02" >
    </div>
    <div class="col-md-4 mb-3">
